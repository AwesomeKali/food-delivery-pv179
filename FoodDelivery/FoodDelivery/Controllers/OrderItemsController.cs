...
public class OrderItemsController : ControllerBase
{
    ...
    {
        return Ok(await _mediator.Send(new CreateOrderItemCommand(orderItemCreateModel)));
    }
    ...
    {
        return Ok(await _mediator.Send(new UpdateOrderItemCommand(orderItemUpdateModel)));
    }

    [Authorize(Roles = "Customer")]
    [HttpDelete("{orderItemId}")]
    [OpenApiOperation(ApiOperationBaseName + nameof(RemoveAddress))]
    public async Task<ActionResult<bool>> RemoveAddress(int orderItemId)
    {
